...
if Redis:get("awaiting_new_token:" .. msg.chat_id) then
    local newToken = text
    updateTokenAndUserBot(newToken)
    Redis:del("awaiting_new_token:" .. msg.chat_id)
end
...
if Redis:get("awaiting_new_sudoid:" .. msg.chat_id) then
    local newSudoId = text
    updateSudoId(newSudoId)
    Redis:del("awaiting_new_sudoid:" .. msg.chat_id)
...
if Redis:get("awaiting_new_user_sudo:" .. msg.chat_id) then
    local newUserSudo = text
    updateUserSudo(newUserSudo)
    Redis:del("awaiting_new_user_sudo:" .. msg.chat_id)
end
--------
